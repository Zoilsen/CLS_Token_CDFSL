...
def parse_args(script):
    ...
    parser.add_argument('-dataset', default='CropDiseases')
    parser.add_argument('-testset', default='CropDiseases')
    ...
    parser.add_argument('-clsToken_domainToken_orth_w', type=float, default=0.0)
